        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::open(['url' => 'backend/password/email', 'class' => 'form-horizontal']) !!}
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-md-offset-4">
                            {!! Form::submit(trans('labels.backend.passwords.send_password_reset_link_button'), ['class' => 'btn btn-primary']) !!}
                        </div><!--col-md-6-->
                    </div><!--form-group-->
